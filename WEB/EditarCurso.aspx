<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EditarCurso.aspx.vb" Inherits="WEB.EditarCurso" %>
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="mb-4">
         ...
         <asp:Button ID="Editar" CssClass="btn btn-primary" runat="server" Text="Editar" />
    </div>
